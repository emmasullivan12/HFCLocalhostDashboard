// Last merged this code on 7th feb 2024
...
class CommunityLeaderboard extends React.Component {
  ...
  render() {
    ...
    const mentees = [
      {uid: 'uuid1234', fname: 'Adam', lname: 'Ant', topContributionType: 'answer', topContributionID: '123', numAnswers: 0, numGenerals: 0, numQs: 0, numMentees: 0, numMentors: 0, isU18: true, eetstatus: 'uni', currco: '', currtrainingprovider: '', uninamefreetext: 'FreeTextUniName', uniname: '', currrole: '', currtraining: '', degree: 'MA Animation & VFX', state: '', country: ''},
      {uid: 'uuid1245', fname: 'Busy', lname: 'Bee', topContributionType: 'general', topContributionID: '234', numAnswers: 0, numGenerals: 0, numQs: 0, numMentees: 0, numMentors: 1, isU18: false, eetstatus: 'sch', currco: '', currtrainingprovider: '', uninamefreetext: '', uniname: '', currrole: '', currtraining: '', degree: '', state: '', country: ''},
      {uid: 'uuid1256', fname: 'Charlie', lname: 'Chaplin', topContributionType: '', topContributionID: '', numAnswers: 0, numGenerals: 0, numQs: 0, numMentees: 0, numMentors: 1, isU18: true, eetstatus: 'none', currco: '', currtrainingprovider: '', uninamefreetext: '', uniname: '', currrole: '', currtraining: '', degree: '', state: 'CA', country: 'USA'},
      {uid: 'uuid1267', fname: 'Adam', lname: 'Bant', topContributionType: 'answer', topContributionID: '123', numAnswers: 0, numGenerals: 0, numQs: 0, numMentees: 0, numMentors: 3, isU18: true, eetstatus: 'job', currco: 'Starbucks', currtrainingprovider: '', uninamefreetext: '', uniname: '', currrole: 'Barista', currtraining: '', degree: '', state: '', country: ''},
      {uid: 'uuid1278', fname: 'Charlie', lname: 'Chaplin', topContributionType: '', topContributionID: '', numAnswers: 0, numGenerals: 0, numQs: 0, numMentees: 0, numMentors: 2, isU18: false, eetstatus: 'none', currco: '', currtrainingprovider: '', uninamefreetext: '', uniname: '', currrole: '', currtraining: '', degree: '', state: 'NY', country: 'USA'},
      {uid: 'uuid1289', fname: 'Busy', lname: 'Cee', topContributionType: 'general', topContributionID: '234', numAnswers: 0, numGenerals: 0, numQs: 0, numMentees: 0, numMentors: 1, isU18: false, eetstatus: 'train', currco: '', currtrainingprovider: 'Escape Studios', uninamefreetext: '', uniname: '', currrole: '', currtraining: '3D Compositing', degree: '', state: '', country: ''},
      {uid: 'uuid1210', fname: 'Busy', lname: 'Dee', topContributionType: 'general', topContributionID: '234', numAnswers: 0, numGenerals: 0, numQs: 0, numMentees: 0, numMentors: 0, isU18: true, eetstatus: 'train', currco: '', currtrainingprovider: 'Escape Studios', uninamefreetext: '', uniname: '', currrole: '', currtraining: '3D Compositing', degree: '', state: '', country: ''},
    ];
