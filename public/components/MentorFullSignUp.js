...
class MentorFullSignUp extends Component {
  render() {
    ...
    var questions = [
      ...
      {q: 'Did you want to focus your efforts on supporting any of these particular communities?', detail: 'You might be particularly passionate about one of these ... or want to add your own (and we\'ll try our best to match you)!', aType: 'autocompleteMulti', req: 1, showCheckbox: true, openOnClick: true, showValues: false, maxTextLength: 150, placeholder: 'Select communities...', placeholderOnClick: 'Choose from our list or add your own:', name: 'erg', idValue: 'value', valueToShow: 'label', options: [
      ...
      ... (maxEdu != 'uni') ? [
        {q: 'What\'s the highest level of education you\'ve achieved?', aType: 'select', req: 1, placeholder: 'Select option...', name: 'maxEdu', valueToShow: 'label', options: [
          ...
          {value: '5', label: 'PhD'},
          {value: '5', label: 'Professional Qualification (e.g. CPA / ACA / IMechE)'},
        ]},
      ] : [],
