...
class MentorFullSignUp extends Component {
  render() {
    ...
    var questions = [
      ...
      {q: 'Did you want to focus your efforts on supporting any of these particular communities?', detail: 'You might be particularly passionate about some of these ... or want to add your own (and we\'ll try our best to match you accordingly)!', aType: 'autocompleteMulti', req: 1, showCheckbox: true, openOnClick: true, showValues: false, maxTextLength: 150, placeholder: 'Select communities...', placeholderOnClick: 'Choose from our list or add your own:', name: 'erg', idValue: 'value', valueToShow: 'label', options: [
      ...
      ... (eetStatus != 'uni') ? [
        ...
        ... (country === 'GBR') ? [
          {q: 'Which University did you go to?', detail: 'Sometimes students prefer to speak with an alumni from their own institution to help visualise where they can get to', aType: 'autocomplete', req: 1, placeholder: 'Type your Degree name...', name: 'uniName', componentUpdatesState: 'ukUnisList', fileToRender: 'UKUnis', idValue: 'value', valueToShow: 'label', showDetail: 1, detailToShow: 'location', noSuggestionsCTAclass: 'ModalOpenBtn ModalOpenBtn-noSuggestionsCTABtn'},
        ] : [],
        ... (country != 'GBR') ? [
          {q: 'Which University did you go to?', detail: 'Sometimes students prefer to speak with an alumni from their own institution to help visualise where they can get to', aType: 'text', req: 1, maxLength: 75, placeholder: 'Type your Degree name...', name: 'uniName'},
        ] : [],
    ...
    return (
      <section>
        <div className="contentBox landingCTA">
          ...
          <div>
            <FullPageModal {...MentorFullSignUpProps}>
              <Form
                questions={questions}
                usedFor="mentorFullSU"
              />
