...
class LeaderboardItem extends Component {
  ...
  render() {
    const {user, index, isLastItem, userTypeToShow, checkHasAccess, noAccessHandler, isMobile} = this.props;
    ...
    return(
      <React.Fragment>
        <tr>
          ...
          <td className={(isMobile == true ? "textLeft paddingR" : "textLeft paddingR20")}>
          ...
          <td className={(isMobile == true ? "alignCenter fontSize13 paddingR15" : "textLeft paddingL20")}>
            <span className="displayInlineBlock pointsIcon tooltip">
              ...
              <span className={"tooltiptext last messageActions" + (isLastItem == true ? "" : " below")}>No. Q answered</span>
          ...
          <td className={(isMobile == true ? "alignCenter fontSize13 paddingR15" : "textLeft paddingL30")}>
            <span className={"fontSize12 pointsIcon tooltip" + (isMobile == true ? "" : " paddingR5")}><i className="fas fa-pencil-alt" />
              <span className={"tooltiptext last messageActions" + (isLastItem == true ? "" : " below")}>No. general posts</span>
          ...
          <td className={(isMobile == true ? "alignCenter fontSize13 paddingR5" : "textLeft paddingL30")}>
            <span className={"fontSize12 pointsIcon tooltip" + (isMobile == true ? "" : " paddingR5")}><i className="fas fa-user-friends" />
              <span className={"tooltiptext last messageActions" + (isLastItem == true ? "" : " below")}>No. of mentees</span>
