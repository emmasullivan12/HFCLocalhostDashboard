...
class BackgroundCheck extends React.Component {
  ...
  render() {
    ...
    const usersToCheck = [
      {uuid: 'uuid123', fname: 'Anxious', lname: 'Ant', state: 'CA', country: 'USA', ukConv: null, usConv1: 1, usConv2: null, usConv3: null, usConv4: null, idpic: '', profurl: 'www.google.com', cv: 'www.google.com', eetstatus: 'job', currrole: 'Animator', currco: 'Framestore', currtraining: '', currtrainingprovider: ''},
      {uuid: 'uuid124', fname: 'Big', lname: 'Boris', state: 'Suss', country: 'GBR', ukConv: 1, usConv1: null, usConv2: null, usConv3: null, usConv4: null, idpic: '', profurl: '', cv: 'www.google.com', eetstatus: 'job', currrole: '2D Animator', currco: 'DNEG', currtraining: '', currtrainingprovider: ''},
      {uuid: 'uuid125', fname: 'Crumbly', lname: 'Carol', state: 'QC', country: 'CAN', ukConv: null, usConv1: 1, usConv2: 1, usConv3: null, usConv4: null, idpic: '', profurl: 'www.google.com', cv: 'www.google.com', eetstatus: 'job', currrole: '3D Animator', currco: 'ILM', currtraining: '', currtrainingprovider: ''},
      {uuid: 'uuid126', fname: 'Dickhead', lname: 'Dec', state: 'IL', country: 'USA', ukConv: null, usConv1: null, usConv2: null, usConv3: null, usConv4: null, idpic: '', profurl: 'www.google.com', cv: '', eetstatus: 'train', currrole: '', currco: '', currtraining: 'Compositing', currtrainingprovider: 'Training Provider'},
      {uuid: 'uuid127', fname: 'Enormous', lname: 'Eugine', state: 'LdHa', country: 'GBR', ukConv: null, usConv1: null, usConv2: null, usConv3: null, usConv4: null, idpic: '', profurl: 'www.google.com', cv: '', eetstatus: 'train', currrole: '', currco: '', currtraining: 'Houdini Course', currtrainingprovider: 'Online provider'},
      {uuid: 'uuid128', fname: 'Fat', lname: 'Froggy', state: 'BC', country: 'CAN', ukConv: null, usConv1: null, usConv2: null, usConv3: null, usConv4: null, idpic: '', profurl: 'www.google.com', cv: 'www.google.com', eetstatus: 'none', currrole: '', currco: '', currtraining: '', currtrainingprovider: ''},
    ];
