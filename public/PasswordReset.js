...
resetcode.addEventListener('blur', function(event) {
  if(pwd.checkValidity() && pwd.value.length > 7 && this.value.length > 5 && pwd.value.search(/\d/) != -1 && pwd.value.search(/[A-Z]/) != -1 && pwd.value.search(/[!@#$%^&*()_+]/) != -1) {
...
pwd.addEventListener('blur', function(event) {
  if(pwd.checkValidity() && this.value.length > 7 && resetcode.value.length > 5 && this.value.search(/\d/) != -1 && this.value.search(/[A-Z]/) != -1 && this.value.search(/[!@#$%^&*()_+]/) != -1) {
